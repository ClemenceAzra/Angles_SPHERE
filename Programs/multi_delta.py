...
# N_500m_30PeV,p_500m_30PeV,Fe_500m_30PeV=-3,-4,3
...
# plt.legend(title='500 м 30 ПэВ')
# plt.xlabel('$\delta$, $^\circ$')
# plt.ylabel('% от всей выборки')
# plt.ylim(0,35)
# plt.show()
...
# N_500m_10PeV,p_500m_10PeV,Fe_500m_10PeV=0,1,-1
# xx=deltas_bar[:10]+0.25
...
# N_900m_10PeV,p_900m_10PeV,Fe_900m_10PeV=-2,-5,2
# cutting=20
